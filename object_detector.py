...
# def get_hog(img, feature_vector=False):
#     hog_feature = []
#     hog_feature.append(get_hog(img, channel=0))
#     hog_feature.append(get_hog(img, channel=1))
#     hog_feature.append(get_hog(img, channel=2))
#     return hog_feature
